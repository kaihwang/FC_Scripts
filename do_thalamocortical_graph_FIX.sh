...
for s in 100307; do
	...
	# run NetCorr
	cd /tmp/KH_${s}
	3dNetCorr -prefix ${s}_thalamocortical_corrmat -inset input.nii.gz -in_rois /home/despoB/kaihwang/Rest/ROIs/WashU333_plus_thalamus_25prob_voxels_ROIset_RPI.nii.gz
