...
gzip 176-EPI-00${r}.nii
3dcopy 176-EPI-00${r}.nii.gz 176_rest_run${r}.nii.gz
rm -rf /home/despo/kaihwang/Rest/Lesion/176/Rest/NNrun${r}/
mkdir /home/despo/kaihwang/Rest/Lesion/176/Rest/NNrun${r}/
mv 176_rest_run${r}.nii.gz /home/despo/kaihwang/Rest/Lesion/176/Rest/NNrun${r}/
cd /home/despo/kaihwang/Rest/Lesion/176/Rest/NNrun${r}/

preprocessFunctional -4d 176_rest_run${r}.nii.gz \
		-tr 2 \
		-mprage_bet /home/despo/kaihwang/Subjects/176/SUMA/176_SurfVol_bet.nii.gz \
		-threshold 98_2 \
		...
		-warpcoef /home/despo/kaihwang/Subjects/176/SUMA/176_SurfVol_warpcoef.nii.gz \
		-startover

cd /home/despo/kaihwang/Rest/Lesion/176/Rest/NNrun${r}/
3dWarp -deoblique -prefix dbrnswdkmt_176_rest_run${r}_6.nii.gz -quintic brnswdkmt_176_rest_run${r}_6.nii.gz
...
3dTcat -prefix 176-rest-preproc-cen.nii.gz -rlt++ \
		NNrun1/dbrnswdkmt_176_rest_run1_6.nii.gz \
		NNrun2/dbrnswdkmt_176_rest_run2_6.nii.gz 

3dTstat -mean -prefix m1.nii.gz NNrun1/wdkmt_176_rest_run1.nii.gz
3dTstat -mean -prefix m2.nii.gz NNrun2/wdkmt_176_rest_run2.nii.gz
3dTstat -stdev -prefix s1.nii.gz NNrun1/wdkmt_176_rest_run1.nii.gz
3dTstat -stdev -prefix s2.nii.gz NNrun2/wdkmt_176_rest_run2.nii.gz
3dcalc -a m1.nii.gz -b m2.nii.gz -c s1.nii.gz -d s2.nii.gz -expr '((a/c)+(b/d))/2' -prefix 176_tsnr_mean.nii.gz
