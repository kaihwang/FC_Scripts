...
3dcopy wdkmt_218_rest_run${r}.nii.gz 218_rest_proc_run${r}+tlrc
cp /home/despo/kaihwang/Rest/Control/218/Rest/run${r}/motion.par \
		/home/despo/kaihwang/Rest/Control/218/Rest/run${r}/motion.1D
...
afni_restproc.py \
		...
		-epi /home/despo/kaihwang/Rest/Control/218/Rest/run${r}/218_rest_proc_run${r}+tlrc \
		-dest /home/despo/kaihwang/Rest/Control/218/Rest/reg_run${r}/ \
		-prefix 218-preproc-run${r} \
		-align off -episize 3 \
		-dreg -regressor /home/despo/kaihwang/Rest/Control/218/Rest/run${r}/motion.1D \
		-bandpass -bpassregs -polort 2 \
		-wmsize 20 -tsnr -smooth off -script afniproc_run${r}

cd /home/despo/kaihwang/Rest/Control/218/Rest/reg_run${r}/
afni_restproc.py -apply_censor \
		218-preproc-run${r}.cleanEPI+tlrc \
		/home/despo/kaihwang/Rest/Control/218/Rest/run${r}/motion_info/censor_intersection.1D \
		218-preproc-run${r}-censored

rm -rf /home/despo/kaihwang/Rest/Control/218/Rest/reg_run${r}/tmp
rm /home/despo/kaihwang/Rest/Control/218/Rest/run${r}/*t_*run*
done
