...
rm -rf /home/despo/kaihwang/Rest/BG/b138/Rest/NNrun${r}/
mkdir /home/despo/kaihwang/Rest/BG/b138/Rest/NNrun${r}/
mv b138_rest_run${r}.nii.gz /home/despo/kaihwang/Rest/BG/b138/Rest/NNrun${r}/
cd /home/despo/kaihwang/Rest/BG/b138/Rest/NNrun${r}/
...
cd /home/despo/kaihwang/Rest/BG/b138/Rest/NNrun${r}/
3dWarp -deoblique -prefix dbrnswdkmt_b138_rest_run${r}_6.nii.gz -quintic brnswdkmt_b138_rest_run${r}_6.nii.gz
...
3dTcat -prefix b138-rest-preproc-cen.nii.gz -rlt++ \
		NNrun1/dbrnswdkmt_b138_rest_run1_6.nii.gz \
		NNrun2/dbrnswdkmt_b138_rest_run2_6.nii.gz 

3dTstat -mean -prefix m1.nii.gz NNrun1/wdkmt_b138_rest_run1.nii.gz
3dTstat -mean -prefix m2.nii.gz NNrun2/wdkmt_b138_rest_run2.nii.gz
3dTstat -stdev -prefix s1.nii.gz NNrun1/wdkmt_b138_rest_run1.nii.gz
3dTstat -stdev -prefix s2.nii.gz NNrun2/wdkmt_b138_rest_run2.nii.gz
3dcalc -a m1.nii.gz -b m2.nii.gz -c s1.nii.gz -d s2.nii.gz -expr '((a/c)+(b/d))/2' -prefix b138_tsnr_mean.nii.gz
