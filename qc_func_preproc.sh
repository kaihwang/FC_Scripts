...
# 114 116 117 118 119 201 203 204 205 206 207 208 209 210 211 212 213 214 215 216 217 218 219 220

#for control subjects
for s in 118 214 216 217 219; do
		...
		echo "rm -rf /home/despo/kaihwang/Rest/Control/${s}/Rest/NNrun\${r}/" >> f_${s}.sh
		echo "mkdir /home/despo/kaihwang/Rest/Control/${s}/Rest/NNrun\${r}/" >> f_${s}.sh
		echo "mv ${s}_rest_run\${r}.nii.gz /home/despo/kaihwang/Rest/Control/${s}/Rest/NNrun\${r}/" >> f_${s}.sh
		echo "cd /home/despo/kaihwang/Rest/Control/${s}/Rest/NNrun\${r}/" >> f_${s}.sh
		echo "" >> f_${s}.sh
