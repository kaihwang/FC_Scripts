...
#	echo "3dTcat -prefix ${s}-rest-preproc-cen.nii.gz -rlt++ \\
#	run1/brnswdkmt_${s}_rest_run1_6.nii.gz \\
#	run2/brnswdkmt_${s}_rest_run2_6.nii.gz " >> cc_${s}.sh
#	echo "" >> cc_${s}.sh
	
#	echo "3dTstat -mean -prefix m1.nii.gz run1/wdkmt_${s}_rest_run1.nii.gz" >> cc_${s}.sh
#	echo "3dTstat -mean -prefix m2.nii.gz run2/wdkmt_${s}_rest_run2.nii.gz" >> cc_${s}.sh
	
#	echo "3dTstat -stdev -prefix s1.nii.gz run1/wdkmt_${s}_rest_run1.nii.gz" >> cc_${s}.sh
#	echo "3dTstat -stdev -prefix s2.nii.gz run2/wdkmt_${s}_rest_run2.nii.gz" >> cc_${s}.sh
